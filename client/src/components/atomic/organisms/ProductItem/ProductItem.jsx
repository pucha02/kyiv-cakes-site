...
export const ProductItem = ({ id, name, cost, src, description, updateTotal, openModal, openCart }) => {
  ...
  return (
    <div className="product-card">
      <ProductImage src={src || ProdImg} alt={name} onClick={() => openModal({ id, name, cost, image: src || ProdImg, description })} />
